...
<template>
  <div class="login">
    ...
    <div class="login-text">
      ...
      <hr />
      <h2>Login</h2>
      <img src="~/assets/img/henrique.jpg" alt="henrique" class="login-user" />
      ...
      <br />
      <p>Not registered yet ? <a href="#" class="normal-link">Register !</a></p>
    </div>
  </div>
</template>
...
<script>
export default {
  /* Use the "login.vue" layout for this route */
  layout: 'login',
};
</script>
